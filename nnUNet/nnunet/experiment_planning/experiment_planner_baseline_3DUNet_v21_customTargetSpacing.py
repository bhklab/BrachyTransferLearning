...
class ExperimentPlanner3D_v21_customTargetSpacing(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "nnUNetData_plans_v2.1_trgSp"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_trgSp_plans_3D.pkl")

    def get_target_spacing(self):
        # simply return the desired spacing as np.array
        return np.array([0.625, 0.625, 3.]) # make sure this is float!!!! Not int!