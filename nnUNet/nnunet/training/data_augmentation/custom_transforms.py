...
def convert_3d_to_2d_generator(data_dict):
    ...
    # shp = data_dict['dist'].shape
    # data_dict['dist'] = data_dict['dist'].reshape((shp[0], shp[1] * shp[2], shp[3], shp[4]))
    # data_dict['orig_shape_dist'] = shp
    return data_dict
...
def convert_2d_to_3d_generator(data_dict):
    ...
    # shp = data_dict['orig_shape_dist']
    # current_shape_dist = data_dict['dist'].shape
    # data_dict['dist'] = data_dict['dist'].reshape((shp[0], shp[1], shp[2], current_shape_dist[-2], current_shape_dist[-1]))
    return data_dict
