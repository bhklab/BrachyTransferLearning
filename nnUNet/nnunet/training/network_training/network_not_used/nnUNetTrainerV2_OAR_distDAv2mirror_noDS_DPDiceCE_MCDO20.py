...
from nnunet.training.data_augmentation.data_augmentation_distDAv2_mirror import get_distDAv2_augmentation
...
class nnUNetTrainerV2_OAR_distDAv2mirror_noDS_DPDiceCE_MCDO20(nnUNetTrainerV2):
