...
from nnunet.training.loss_functions.DP_loss import DC_and_DPCE_loss, DPCE_loss

class nnUNetTrainerV2_changed_distDAv2_DPCE(nnUNetTrainer):
    """
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            if training:
                ...
                self.tr_gen, self.val_gen = get_distDAv2_augmentation(
