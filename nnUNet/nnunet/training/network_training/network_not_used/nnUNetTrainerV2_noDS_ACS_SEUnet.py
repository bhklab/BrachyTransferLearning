...
from nnunet.training.network_training.nnUNetTrainerV2_changedACS import nnUNetTrainerV2_changedACS
...
class nnUNetTrainerV2_noDS_ACS_SEUnet(nnUNetTrainerV2_changedACS):
    ...
    def initialize_network(self):
        ...
        model_2d = SE_Unet(in_ch=self.num_input_channels, out_ch=self.num_classes)
        # model_2d = model_2d = smp.Unet(
