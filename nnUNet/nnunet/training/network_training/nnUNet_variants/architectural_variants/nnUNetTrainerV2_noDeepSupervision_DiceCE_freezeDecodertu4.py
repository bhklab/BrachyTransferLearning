...
class nnUNetTrainerV2_noDeepSupervision_DiceCE_freezeDecodertu4(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        '''freeze weight in Encoder layers (and transposed convolutions)'''
        for param in self.network.conv_blocks_localization.parameters():
            param.requires_grad = False 
        for param in self.network.tu.parameters():
            param.requires_grad = False
